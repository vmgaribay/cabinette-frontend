...
jest.doMock("./components/FilteredMap", () => ({ __esModule: true, default: mockFilteredMap }));
jest.doMock("./components/WeightsProxies", () => ({ __esModule: true, default: mockWeightsProxies }));
jest.mock("./components/TextDetails", () => ({ __esModule: true, default: () => <div data-testid="text-details" /> }));
jest.mock("./components/VCPlot", () => ({ __esModule: true, default: () => <div data-testid="vc-plot" /> }));
jest.mock("./components/SiteGauges", () => ({ __esModule: true, default: () => <div data-testid="site-gauges" /> }));
...
describe("Main Page", () => {
  ...
  (global.fetch as jest.Mock)
    ...
    .mockResolvedValueOnce({
      json: async () => [
        { id: "a", combined_overall_avg_monthly_visitation_norm: 1, 
        ...
        { id: "b", combined_overall_avg_monthly_visitation_norm: 2,            combined_min_monthly_visitation_norm: 0,
            combined_max_monthly_visitation_norm: 0,
            nearest_park_min_monthly_visitation_norm: 0,
            nearest_park_max_monthly_visitation_norm: 0,
            nearest_park_overall_avg_monthly_visitation_norm: 0,
            ...
            nearest_vc_distance_norm: 0,
            nearest_road_distance_norm: 0, },
        { id: "c", combined_overall_avg_monthly_visitation_norm: 3,            combined_min_monthly_visitation_norm: 0,
            combined_max_monthly_visitation_norm: 0,
            nearest_park_min_monthly_visitation_norm: 0,
            nearest_park_max_monthly_visitation_norm: 0,
            nearest_park_overall_avg_monthly_visitation_norm: 0,
